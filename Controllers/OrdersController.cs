...
namespace Gestionale.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,OrderDate,ShippedDate,ShipAddress,CustomerID,EmployeeID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,OrderDate,ShippedDate,ShipAddress,CustomerID,EmployeeID")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
